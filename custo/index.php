...
<head>
	...
	<script type="text/javascript" src="../js/controllers/custoListagemController.js"></script>
...
.modal-dialog {
	...
	<body ng-controller="custoListagemController">
	  				...
	  				<div class="panel-body">
	  					<div class="form-group">
							...
							<table class="table table-striped">
								...
								<tr ng-model="custo" ng-repeat="custo in custos" class="row">
									<td class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
										{{custo.id}}
									</td>
									<td>{{custo.nome}}</td>
									<td class="col-xs-1 col-sm-1 col-md-1 col-lg-1">{{custo.valor | currency}}</td>
									<td>{{custo.descricao}}</td>
									<td class="col-xs-1 col-sm-1 col-md-1 col-lg-1 text-right">
										<a href="cadastro?id={{custo.id}}" title="Editar">
									        <img width="25" height="25" src="../img/edit.png">
									    </a>
									    <a href='' data-toggle="modal" data-target='#remover{{id=custo.id}}' title="Remover">
		...
		<div ng-repeat="custo in custos">
			<div class="modal fade" id="remover{{custo.id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="removeTitle" aria-hidden="true">
