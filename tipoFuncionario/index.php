...
<html ng-app="suriEmu">
<head>
	<title>SURI-EMU - Tipos de Funcionario</title>
	...
	<script type="text/javascript" src="../js/controllers/tipoFuncionarioListagemController.js"></script>
...
.modal-dialog {
	...
	<body ng-controller="tipoFuncionarioListagemController">
		...
		<div class="container">
			...
			<div>
				<ol class="breadcrumb">
				  <li><a href=''>Home</a></li>
				  <li class="active">Tipos de Funcionario</li>
				</ol>
			</div>
				...
				<div class="panel panel-primary">
	  				<div class="panel-heading">
	  					<h2>
	  						<div class="row">
	  							<div class="col-xs-10">
	  								<span>Tipos de Funcionario</span>
	  							</div>
	  					...
	  					<div class="form-group">
							...
							<table class="table table-striped">
								<tr class="row">
									...
									<th>Nome</th>
									<th class="col-xs-1 col-sm-1 col-md-1 col-lg-1">Sigla</th>
									<th class="col-xs-1 col-sm-1 col-md-1 col-lg-1">Horas de Trabalho</th>
									<th>Descricao</th>
									<th class="col-xs-1 col-sm-1 col-md-1 col-lg-1"></th>
								</tr>
								<tr ng-model="tiposFuncionario" ng-repeat="tipoFuncionario in tiposFuncionario" class="row">
									<td class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
										{{tipoFuncionario.id}}
									</td>
									<td>{{tipoFuncionario.nome}}</td>
									<td class="col-xs-1 col-sm-1 col-md-1 col-lg-1">{{tipoFuncionario.sigla}}</td>
									<td class="col-xs-1 col-sm-1 col-md-1 col-lg-1">{{tipoFuncionario.horasDeTrabalho}}</td>
									<td>{{tipoFuncionario.descricao}}</td>
									<td class="col-xs-1 col-sm-1 col-md-1 col-lg-1 text-right">
										<a href="cadastro?id={{tipoFuncionario.id}}" title="Editar">
									        <img width="25" height="25" src="../img/edit.png">
									    </a>
									    <a href='' data-toggle="modal" data-target='#remover{{id=tipoFuncionario.id}}' title="Remover">
		...
		<div ng-repeat="tipoFuncionario in tiposFuncionario">
			<div class="modal fade" id="remover{{tipoFuncionario.id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="removeTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
					  ...
					  <div class="modal-footer">
					    ...
					    <a href="remover?id={{tipoFuncionario.id}}">
					    	<button type="button" class="btn btn-primary">Excluir</button>
					    </a>
					  </div>
					</div>
